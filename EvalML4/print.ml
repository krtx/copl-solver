...
and pp_value ppf = function
  ...
  | VNil -> fprintf ppf "[]"
  | VCons (v1, v2) -> fprintf ppf "(%a :: %a)" pp_value v1 pp_value v2
...
and pp_rule ppf = function
  ...
  | EVar1 -> fprintf ppf "E-Var"
  | EVar2 -> fprintf ppf "E-Var"
  ...
  | ENil -> fprintf ppf "E-Nil"
  | ECons -> fprintf ppf "E-Cons"
  | EMatchNil -> fprintf ppf "E-MatchNil"
  | EMatchCons -> fprintf ppf "E-MatchCons"
